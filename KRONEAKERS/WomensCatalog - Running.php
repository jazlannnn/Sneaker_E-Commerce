...
<html>
    <head>
        <title>	White Canvas | Women's catalog - Running </title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div style="height: 900px;display:flex; width:100%">
            <div id="mySidebar" class="sidebar">
                ...
                <a style="color:white" href="WomensCatalog - Running.php">Running</a>
            ...
            <div id="main">
                ...
                <div class="InnerContainer">
                    <h1 style="text-align:center;">Women's Running</h1>    
                    ...
                    <div style="display:flex;">
                        <?php
                            ...
                            WHERE Product_Gender LIKE 'Women'
