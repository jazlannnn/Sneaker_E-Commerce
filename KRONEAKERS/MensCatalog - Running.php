<?php
	...
	if (isset($_POST['Add'])){
		...
		if(isset($_SESSION['user_id'])){
			...
			{	//create session if its the first time adding to cart
				$item_array = array(
					'product_id'=>$_POST['product_id'],
					'product_name'=>$_POST['product_name'],
					'product_price'=>$_POST['product_price'],
...
<html>
	<head>
		<title>	White Canvas | Men's catalog - Running </title>
		<meta charset="UTF-8">
	...
	<body>
		...
		<!--------------------- Page banner -------------------->
		<div><img src="Images/Image for users/MensCatalogBanner2.png" style="width: 100%" /></div><br><br>
		...
		<div style="height: 900px;display:flex; width:100%">
			<div id="mySidebar" class="sidebar">
				...
				<a style="color:white" href="MensCatalog - Running.php">Running</a>
			...
			<div id="main">
				...
				<div class="InnerContainer">
					<h1 style="text-align:center;">Men's Running</h1>	
					...
					<div style=" display:flex;">
						<?php
							$sql = "SELECT * FROM product
									WHERE Product_Gender LIKE 'Men'
									AND Product_Category LIKE 'Running'";
