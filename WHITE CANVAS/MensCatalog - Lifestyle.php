...
<html>
<head>
    <title>White Canvas | Men's catalog - Lifestyle</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div style="height: 900px;display:flex; width:100%">
        <div id="mySidebar" class="sidebar">
            ...
            <a style="color:white" href="MensCatalog - Lifestyle.php">Lifestyle</a>
        ...
        <div id="main">
            ...
            <div class="InnerContainer">
                <h1 style="text-align:center;">Men's lifestyle</h1>
                ...
                <div style="display:flex;">
                    ...
                    $sql = "SELECT * FROM product
                        ...
                        AND Product_Category LIKE 'Lifestyle'";
